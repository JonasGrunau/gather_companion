  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        // Only the list. The pull used to also drop and reopen the socket, on
        // the theory that a pull means "all of it" — in practice the socket
        // looks after itself, and the reconnect's only visible effect was the
        // link strip popping in over the history it was refreshing.
        ...
        child: CustomScrollView(
          ...
          slivers: [
            ...
            else if (state.activityError == null && !state.activityFetched)
              // Nothing has answered yet, so nothing is claimed yet: bones
              // where the rows will be, not "nothing yet" — see [_Skeleton].
...
/// screen breathing, not an alarm blinking. VoiceOver gets the sentence the
/// bones replaced; the bones themselves say nothing.
